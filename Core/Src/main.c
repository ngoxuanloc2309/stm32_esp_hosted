...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
// void SPI_CS_Low(void)  { HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_RESET); }
// void SPI_CS_High(void) { HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_SET); }

// void SPI_SendReceive(void)
// {
//     SPI_CS_Low();
